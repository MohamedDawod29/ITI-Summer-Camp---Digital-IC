...
if int(parameters_num) == 0:
    ...
    for i in range(int(parameters_num)):
        while True:
            ...
            if name not in parameter_names and name[0].isalpha():
...
for i in range(int(num_inputs)):
    while True:
        ...
        if name not in input_names and (name[0].isalpha() or name[0] == "_"):
...
for i in range(int(num_outputs)):
    while True:
        ...
        if name not in output_names and name not in parameter_names and name not in input_names and (name[0].isalpha() or name[0] == "_"):
